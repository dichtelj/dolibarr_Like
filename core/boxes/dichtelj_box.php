 ...
 */
class dichteljbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "dichtelj@dichtelj";
    public $boxlabel;
    public $depends = array("dichtelj");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/dichtelj/class/dichtelj.class.php";
